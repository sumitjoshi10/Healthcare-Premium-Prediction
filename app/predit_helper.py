...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        'age', 'number_of_dependants', 'income_lakhs', 'insurance_plan', 'genetical_risk', 'normalized_rist_score',
    ...
    df['normalized_rist_score'] = calculate_normalized_risk(input_dict['Medical History'])
